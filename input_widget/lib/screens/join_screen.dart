...
class _JoinScreenState extends State<JoinScreen> {
  ...
  final config = picker.CalendarDatePicker2Config(
    ...
    // isNegative : 음수인지 확인 (특정 날짜와 어제 날짜 사이의 차이 음수면 true)
                        ...
                        suffixIcon: GestureDetector(
                          onTap: () async {
                                ...
                                return Dialog(
                                  child: picker.CalendarDatePicker2(
                                    ...
                                    onValueChanged: (dates) {
                                      print(dates[0]);
                                      if(dates.isNotEmpty) {
                                        Navigator.pop(context, dates);  // 선택한 날짜 변환
                                      }
                                    },
                                  )
                                );
                            ...
                            if(result != null && result.isNotEmpty) {
                              ...
                              final formatDate = "${selectedDate.year}/${selectedDate.month.toString().padLeft(2, '0')}/${selectedDate.day.toString().padLeft(2, "0")}";
                              print("포맷 날짜 : ${formatDate}");
